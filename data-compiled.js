...
var resume = {
	...
	work: [{
		...
		responsibilities: ['Providing ongoing support to existing clients, resolving customer queries.', 'Enhancing customer websites with new functionality.', 'Ensuring quality standards are maintained.', 'Refactoring existing code to comply with modern standards.', 'Contributing to QA in a group setting, including quality assurance of colleagues code.', 'Documenting functionality and providing training materials for clients.', 'Quoting and scoping of website enhancements and micro projects.', 'Training new recruits.']
	}, {
		company: '24 Digital',
		...
		responsibilities: ['Worked on new client projects.', 'Built two websites using WordPress (one has since been upgraded).', 'Created the nharchitecture.net website based on design specifications provided by the client.', 'Created an image gallery plug-in to display images and video content, and asynchronously downloading images.', 'Used Google Maps API to generate a custom-styled map.', 'Migrated existing data to new website.', 'Implemented ajax across the site to allow for dynamic components.', 'Integrated social media widgets.', 'Optimised the UX around image loading.', 'Used responsive design best practices to cater for mobile and tablet.', 'Integrated gravity forms.', 'Built with advanced customer fields.']
	}, {
		...
		responsibilities: ['Average of 90 calls answered per day.', 'Average call time 4.08mins.', 'Meeting required Quality Assurance targets.Responsibilities:', 'Multi skilled in all different aspects of consumer banking e.g. Internet Banking, Telephone Banking, Retail Banking (savings accounts), Credit Cards, Variable Rate Home Loans, Term Deposits.', 'Keeping up to date with ever changing information and practices.', 'Following predetermined best practice procedures to ensure customers receive the most relevant information.', 'Liaise with different internal departments to ensure customer\'s needs are met.', 'Recognise sales opportunities and refer the customer to the sales team.', 'Working as part of a large team to collectively meet targets.', 'Upholding Commonwealth Bank\'s code of ethics and conduct while dealing with customers and colleagues and to remain compliant with government regulation.']
	}, {
		company: 'ANZ Bank, ACC, Melbourne, VIC',
		url: 'http://anz.com',
		title: 'Customer Service Consultant',
		dates: 'June 2010 - March 2011',
		responsibilities: ['Average of 170 calls answered per day.', 'Average call time 1.58mins.', 'Meeting required Quality Assurance targets.', 'Maintaining highest possible score on internal Customer Satisfaction Survey.Responsibilities:', 'Multi skilled in all different aspects of consumer banking e.g. Internet Banking, Telephone Banking, Retail Banking (savings accounts), Credit Cards, Variable Rate Home Loans, Term Deposits, Esanda Term Deposits, Aussie Credit Cards.', 'Keeping up to date with ever changing information and practices.', 'Following predetermined best practice procedures to ensure customers receive the most relevant information, ensuring ANZ has one voice when talking to customers.', 'Liaise with different internal departments of the ANZ to ensure customer\'s needs are met.', 'Recognise sales opportunities and refer the customer to the sales team.', 'Working as part of a large team to collectively meet targets.', 'Upholding ANZ\'s code of ethics and conduct while dealing with customers and colleagues and to remain compliant with government regulation.']
	}, {
